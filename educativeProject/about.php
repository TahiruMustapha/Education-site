    ...
    <section class="about">
      ...
      <div class="content">
        ...
        <p>
          ...
          aliquid pariatur soluta, voluptatum quidem provident illo odit facere
          blanditiis.
        </p>
        ...
        <div class=" swiper-wrapper">
          <div class=" swiper-slide slide">
            <p>
              ...
              blanditiis amet dignissimos sed. Porro velit ex repellendus sequi
              obcaecati sed!
            </p>
            <img src="images/pic-1.png" alt="review pic">
            <h3>Abubakar Mustapha</h3>
            <div class="stars">
          ...
          <div class="swiper-slide slide">
            ...
            <img src="images/pic-2.png" alt="review pic">
            <h3>Abubakar Mustapha</h3>
            <div class="stars">
              <i class="fas fa-star" ></i>
              <i class="fas fa-star" ></i>
          ...
          <div class="swiper-slide slide">
            ...
            <img src="images/pic-3.png" alt="review pic">
            <h3>Abubakar Mustapha</h3>
            <div class="stars">
              <i class="fas fa-star" ></i>
              <i class="fas fa-star" ></i>
          ...
          <div class="swiper-slide slide">
            ...
            <img src="images/pic-4.png" alt="review pic">
            <h3>Abubakar Mustapha</h3>
            <div class="stars">
              <i class="fas fa-star" ></i>
              <i class="fas fa-star" ></i>
          ...
          <div class="swiper-slide slide">
            ...
            <img src="images/pic-5.png" alt="review pic">
            <h3>Abubakar Mustapha</h3>
            <div class="stars">
              <i class="fas fa-star" ></i>
              <i class="fas fa-star" ></i>
          ...
          <div class="swiper-slide slide">
            ...
            <img src="images/pic-6.png" alt="review pic">
            <h3>Abubakar Mustapha</h3>
            <div class="stars">
              <i class="fas fa-star" ></i>
              <i class="fas fa-star" ></i>
